 ...
 *
 * -------------------------------------------------------------------
 *   Analisador sint�tico do arquivo indicado
 *   A regra b�sica �: 
 *   [RXX[:]] XXXX [P1 [P2 [P3]]] 
 * ------------------------------------------------------------------- */
...
// A regra abaixo coloca na vari�vel global "rotInstr" o string
...
comando :
  ...
  | cmd_um_param_rot param1_rot // Comandos com um parametro que � um rotulo 
  {
