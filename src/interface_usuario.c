...
char *_03_ajuda_modo_interativo = "Modo interativo:                   \n"
                                  "       q => sai                    \n"
                                  "       r => resume execucao        \n"
...
void imprime_params_linha_comando(params_linha_comando *plc) {
  ...
  printf(_01_resumo_param_linha_comando, plc->arq_in,
...
int alguem_no_vetor_impr() { return (_inicio_vetor_impr == _fim_vetor_impr); }
...
void iniciaInterfaceUsuario() { iniciaTabInstr(); }
